...
SECRET_KEY = 'django-insecure-wcg-sujp4tmcdo)*y2fzs%$caa(ls(dc8++csdk8%&@=!su6wu'
...
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    'undeferred-halle-breechless.ngrok-free.dev'
]
...
# import urllib.parse
# password = urllib.parse.quote_plus("vinove@123")  # encode special chars
# DATABASES = {
#     'default': {
